                ...
                @if(count($this->massActionsOptions))
                    <div class="flex items-center justify-center space-x-1">
                        ...
                        <button
                            ...
                            class="flex items-center px-4 py-2 text-xs font-medium tracking-wider text-gray-700 uppercase border border-gray-800 rounded-md leading-4 hover:bg-sky-200 focus:outline-none" type="submit" title="Descargar"
                        >Descargar</button>
                    </div>
                @endif
